    ...
    ui(new Ui::MainWindow)
{
    ...
    //
    this->updateUI();
    ui->headerWidget->setHeadingText("SimCenter Site Response Tool");
    ...
    ui->textBrowser->setHtml("<b>Hints</b><p><ul><li>The Site Response Tool uses metric units: meters, kN, and kPa. </li><li>Select piles or soil layers to display and/or change by clicking on the pile inside the System Plot </li><li>go to Preferences to select which result plots are shown. </li></ul>");
    ...
    manager->get(QNetworkRequest(QUrl("http://opensees.berkeley.edu/OpenSees/developer/SRT/use.php")));
