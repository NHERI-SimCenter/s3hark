...
rst_prolog = """
.. |appName| replace:: *s*\ :sup:`3`\ *hark*
.. |s3harkName| replace:: *s*\ :sup:`3`\ *hark*
.. |full tool name| replace:: Site-specific Seismic Hazard Analysis & Research Kit 
.. |short tool name| replace:: s3hark
.. |short tool id| replace:: s3hark
.. |tool github link| replace:: `s3hark Github page`_
.. _s3hark Github page: https://github.com/NHERI-SimCenter/s3hark
.. |tool version| replace:: 1.1.1
