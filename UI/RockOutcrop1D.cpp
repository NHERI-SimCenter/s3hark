...
RockOutcrop1D::RockOutcrop1D(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::RockOutcrop1D)
{
...
RockOutcrop1D::~RockOutcrop1D()
{
    delete ui;
}

ElementModel* RockOutcrop1D::getElementModel() const
{
    return elementModel;
}

void RockOutcrop1D::onTotalLayerEdited()
{
...
void RockOutcrop1D::on_meshBtn_clicked(bool checked)
{
...
void RockOutcrop1D::hideShowTab()
{
    resultsTab->setVisible(false);
}

void RockOutcrop1D::updateCtrl()
{
...
void RockOutcrop1D::insertWithDialog()
{
...
void RockOutcrop1D::insert()// insert from dialog
{
...
void RockOutcrop1D::insertAbove()
{
    QList<QVariant> emptyList;
...
void RockOutcrop1D::insertBelow()
{
    QList<QVariant> emptyList;
    ui->tableView->insertBelow(emptyList);
    updateCtrl();
...
void RockOutcrop1D::gotoPage(int index)
{
    index++;
...
void RockOutcrop1D::nextPage()
{
    ui->tableView->nextPage();
    updateCtrl();
}

void RockOutcrop1D::prevPage()
{
    ui->tableView->previousPage();
    updateCtrl();
}

void RockOutcrop1D::on_delRowBtn_clicked()
{
    emit ui->tableView->removeAct();
}

void RockOutcrop1D::on_addRowBtn_clicked()
{
 ...
 * @brief RockOutcrop1D::totalHeightChanged
 * @return
 */
void RockOutcrop1D::totalHeightChanged()
{
...
void RockOutcrop1D::on_thickness_edited()
{
...
void RockOutcrop1D::on_rowRemoved(int row)
{
    Q_UNUSED(row);
...
void RockOutcrop1D::on_gwtEdit_textChanged(const QString &newGWT)
{
...
void RockOutcrop1D::on_reBtn_clicked()
{
...
void RockOutcrop1D::on_runBtn_clicked()
{
...
void RockOutcrop1D::onOpenSeesFinished()
{
...
void RockOutcrop1D::writeSurfaceMotion()
{

}

json RockOutcrop1D::createMaterial(int tag, std::string matType, std::string parameters)
{
    json mat = {
        {"id", tag},
        {"type", matType}
